...
import { FaPause, FaHourglassStart, FaStop } from "react-icons/fa"; 
        ...
        <div className="p-6 sm:p-10 space-y-6">
          <div className="flex  space-y-6 md:space-y-0 md:flex-row justify-between">
            ...
            <div className="flex flex-wrap items-start justify-end -mb-3">  
              ...
              <button className="inline-flex px-5 py-3 text-blue-600 hover:text-blue-700 focus:text-blue-700 hover:bg-blue-100 focus:bg-blue-100 border border-purple-blue rounded-md ml-6 mb-3">
          ...
          <div className="h-auto gap-6 ">
            <div class="flex flex-col row-span-3 bg-white shadow rounded-lg">
              ...
              <div class="p-4 flex-grow">
                <div class="flex items-center justify-center h-full px-4 py-24 text-gray-400 text-3xl font-semibold bg-gray-100 border-2 border-gray-200 border-dashed rounded-md">Raspi Camera V2 Module</div>
              </div>
            </div>
          </div>
